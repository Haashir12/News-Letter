...
MAX_CANDIDATES_PER_RUN = 15           # matches this account's real daily cap (RPD 20), with headroom
...
GEMINI_CALL_DELAY_SECONDS = 13        # this account's real limit is 5 requests/minute (60/5=12s minimum)
